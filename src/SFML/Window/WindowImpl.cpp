...
////////////////////////////////////////////////////////////
std::unique_ptr<WindowImpl> WindowImpl::create(VideoMode mode, const String& title, std::uint32_t style, const ContextSettings& settings, bool acceptFiles)
{
    return std::make_unique<WindowImplType>(mode, title, style, settings, acceptFiles);
}
